...
$motor6= $_POST['m6'];
  ...
  if(isset($_POST['save']) ){  
     ...
     $sql= "INSERT INTO `motors`(`Motor1`, `Motor2`, `Motor3`, `Motor4`, `Motor5`, `Motor6`, `ID`) VALUES ('$motor1','$motor2','$motor3','$motor4','$motor5','$motor6','')";
...
header("Location: http://localhost/Fighting/arm.html");
       exit();
